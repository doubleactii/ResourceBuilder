 ...
 * Compiled Thu, 07 Nov 2024 18:33:55 UTC
 *
...
(function (exports, pixi_js) {
     ...
     * and rotation.
     */
    const PositionParticle = 'Position particle per emitter position';
    /**
     * A particle emitter.
     */
    class Emitter {
    ...
    function upgradeConfig(config, art) {
        ...
        // animated
        if (Array.isArray(art) && art[0] && typeof art[0] !== 'string' && 'framerate' in art[0]) {
